...
try {
  ...
  const res=await axios.post("https://food-order-o8dr.onrender.com/api/signup",{...formdata});
          ...
          <div className="card-body p-md-5">
            <div className="row justify-content-center">
              ...
              <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                < input type="image" img src={"https://thumbs.dreamstime.com/z/sign-up-concept-hand-pressing-social-icons-blue-world-map-background-48170000.jpg"}
